                                    ...
                                    <div class="mobile-providers">
                                        <div class="provider-option">
                                            ...
                                            <label for="mpesa" class="provider-label">
                                                <div class="provider-content">
                                                    <img src="/assets/images/m-pesa.png" alt="M-Pesa" class="provider-logo">
                                        ...
                                        <div class="provider-option">
                                            ...
                                            <label for="tigopesa" class="provider-label">
                                                <div class="provider-content">
                                                    <img src="/assets/images/tigo-pesa.png" alt="Tigo Pesa" class="provider-logo">
                                        ...
                                        <div class="provider-option">
                                            ...
                                            <label for="airtel" class="provider-label">
                                                <div class="provider-content">
                                                    <img src="/assets/images/airtel.png" alt="Airtel Money" class="provider-logo">
